                ...
                for si = sr
                    for ci = cr
                        ...
                        fval(tt,ss,cc) = fval(tt,ss,cc) + ...
                            (- sum(1/size(C,1)*Jparam.fact.HbO*Jparam.fact.corr*C(:,1,ti,si,ci), 'omitnan') ...
                            - sum(1/size(C,1)*Jparam.fact.HbR*Jparam.fact.corr*C(:,2,ti,si,ci), 'omitnan') ...
                            + sum(1/size(M,1)*Jparam.fact.HbO*Jparam.fact.mse*M(:,1,ti,si,ci), 'omitnan') ...
                            + sum(1/size(M,1)*Jparam.fact.HbR*Jparam.fact.mse*M(:,2,ti,si,ci), 'omitnan') ...
                            ...
                            + sum(1/size(R,1)*Jparam.fact.HbO*Jparam.fact.fpr*R(:,1,ti,si,ci), 'omitnan') ...
                            + sum(1/size(R,1)*Jparam.fact.HbR*Jparam.fact.fpr*R(:,2,ti,si,ci), 'omitnan')) ...
                            /divider;
                    end
                end
            end
